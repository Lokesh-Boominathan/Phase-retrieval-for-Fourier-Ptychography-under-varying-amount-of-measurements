...
parser.add_argument('--dataset_name', dest='dataset_name', default='fpm', help='name of the dataset')
...
def main(_):
    ...
    with tf.Session(config=config) as sess:
        model = pix2pix(sess, image_size=args.fine_size, batch_size=args.batch_size,
                        ...
                        checkpoint_dir=args.checkpoint_dir, sample_dir=args.sample_dir,training_examples=2800)
